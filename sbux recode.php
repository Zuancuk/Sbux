...
echo ' >> '.$colors->getColoredString("BOT BY Zuan", "green").''.PHP_EOL;
echo ' >> '.$colors->getColoredString("DONATION: - ", "green").''.PHP_EOL.PHP_EOL;
...
$get_imel = curlContents("https://gmailnator.p.rapidapi.com/generate-email");
